...
// pru / chip constants
#define MAX_NUMBER_OF_COLS			640
#define MAX_NUMBER_OF_ROWS			480
#define MAX_NUMBER_OF_DOUBLE_ROWS	480
...
#define MAX_NUM_PIX			        (640*480)	//328 * 252
...
//#define MODULO_SHIFT_PI             MAX_DIST_VALUE/2
